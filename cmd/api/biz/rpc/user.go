...
func CreateUser(ctx context.Context, req *user.RegisterReq) (r *user.RegisterResp, err error) {
...
func CheckUser(ctx context.Context, req *user.LoginReq) (int64, error) {
