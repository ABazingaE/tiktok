...
func (p *CommentActionReq) SetActionType(val int64) {
	p.ActionType = val
}
...
func (p *CommentActionResp) SetBaseResp(val *BaseResp) {
	p.BaseResp = val
}
...
func (p *CommentActionResp) Field1DeepEqual(src *BaseResp) bool {
...
func (p *CommentActionResp) Field2DeepEqual(src *Comment) bool {
...
func (p *CommentListReq) SetToken(val string) {
	p.Token = val
}
...
func (p *CommentListReq) Field1DeepEqual(src string) bool {
...
func (p *CommentListResp) SetBaseResp(val *BaseResp) {
	p.BaseResp = val
}
...
func (p *CommentListResp) Field1DeepEqual(src *BaseResp) bool {
...
func (p *CommentListResp) Field2DeepEqual(src []*Comment) bool {
...
func (p *CommentServiceCommentListArgs) SetReq(val *CommentListReq) {
	p.Req = val
}
