...
func (p *kVideoServiceClient) VideoUpload(ctx context.Context, req *video.VideoUploadReq, callOptions ...callopt.Option) (r *video.VideoUploadResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.VideoUpload(ctx, req)
}
